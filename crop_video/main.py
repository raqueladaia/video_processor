"""
Main entry point for crop video program.

This program provides a GUI-based tool for cropping videos by drawing rectangular
...
def main():
    """Main function for crop video program."""
    print_section_header("Video Crop Tool")
    print("This tool provides a GUI interface for cropping videos into multiple regions.")
    print("Features include interactive rectangle drawing, multi-region cropping, and batch processing.")
    ...
    try:
        ...
        if not ffmpeg_available:
            print("\nCannot start the application - FFmpeg is required for video processing.")
            return False

        print("FFmpeg detected - video processing ready.")
